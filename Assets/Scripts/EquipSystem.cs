...
public class EquipSystem : MonoBehaviour
{
    ...
    private GameObject itemModel; // Added to store the instantiated model
    ...
    private void SetEquippedModel(GameObject selectedItem)
    {
        ...
        itemModel = Instantiate(Resources.Load<GameObject>(selectedItemName + "_Model"), new Vector3(0.6f, 0, 0.4f), Quaternion.Euler(0, 12.5f, 20f));
